...
///
- (void)onAttensionWithTimestampBegin:(NSInteger)timestampBegin timestampEnd:(NSInteger)timestampEnd score:(double)score;
...
- (BOOL)isUseAttension SWIFT_WARN_UNUSED_RESULT;
